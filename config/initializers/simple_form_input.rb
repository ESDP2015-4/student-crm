    ...
    class FileInput < Base
      def input
        ...
        button = template.content_tag(:div, class: 'input-append') do
          # template.tag(:input, id: "pbox_#{idf}",
          #              class: 'string input-small form-control', type: 'text') +
              template.content_tag(:a, "Выбрать", class: 'btn btn-default btn-img', onclick: "$('input[id=#{idf}]').click();")
        end
